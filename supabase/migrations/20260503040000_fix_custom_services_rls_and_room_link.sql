...
DROP POLICY IF EXISTS "Owners can view own custom services" ON public.custom_services;
DROP POLICY IF EXISTS "Owners can insert custom services" ON public.custom_services;
DROP POLICY IF EXISTS "Owners can update own custom services" ON public.custom_services;
DROP POLICY IF EXISTS "Owners can delete own custom services" ON public.custom_services;
...
DROP POLICY IF EXISTS "Owners can view room custom services" ON public.room_custom_services;
DROP POLICY IF EXISTS "Owners can insert room custom services" ON public.room_custom_services;
DROP POLICY IF EXISTS "Owners can delete room custom services" ON public.room_custom_services;
